...
const techLogos = [
    ...
    { node: <img src={"/logos/shadcn-logo.png"} alt="Shadcn UI" className="w-6 h-6" />, title: "Shadcn UI", href: "https://shadcn.com/ui" },
    { node: <img src={"/logos/react-bits-logo.svg"} alt="React Bits" className="w-6 h-6" />, title: "React Bits", href: "https://react-bits.com" },
